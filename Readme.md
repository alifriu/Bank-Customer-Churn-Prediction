...
Setelah dilakukan modeling, didapati bahwa fitur-fitur seperti **CreditScore**, **Geography**, **Gender**, **Age**, **Tenure**, **Balance**, **NumOfProducts**, **HasCrCard**, **IsActiveMember**, dan **EstimatedSalary** mempengaruhi prediksi churn pelanggan. Hasil ini sejalan dengan tujuan awal, yaitu mengidentifikasi faktor-faktor utama yang berkontribusi pada keputusan churn pelanggan, sehingga memberikan pemahaman yang lebih dalam kepada bank mengenai karakteristik yang perlu diperhatikan.
